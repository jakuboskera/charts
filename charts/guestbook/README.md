...
| `global.postgresql.auth.username`            | Name for a custom user to create (overrides `auth.username`)               | `guestbook` |
| `global.postgresql.auth.password`            | Password for the custom user to create (overrides `auth.password`)         | `guestbook` |
| `global.postgresql.auth.database`            | Name for a custom database to create (overrides `auth.database`)           | `guestbook` |
...
| `image.tag`                          | Guestbook image tag (immutable tags are recommended)                                  | `v0.3.3`                |
